      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className={`group relative overflow-hidden rounded-xl px-4 py-3 transition-all duration-200 ease-out ${
              isDarkTheme
          ...
          {isDropdownOpen && (
            <div
              className={`absolute z-50 bottom-full mb-2 w-full min-w-[320px] rounded-xl shadow-2xl border backdrop-blur-sm ${
                isDarkTheme
                  ? "bg-gray-800/95 border-gray-600"
                  : "bg-white/95 border-gray-200"
              } transform origin-bottom transition-all duration-200 ease-out animate-in slide-in-from-bottom-2`}
            >
              <div className="p-2">
                                 {/* AutoPick Option */}
                 <button
        ...
        <div className="flex-1 relative">
          <input
            ...
            } border focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm hover:shadow-md`}
          />
        </div>
